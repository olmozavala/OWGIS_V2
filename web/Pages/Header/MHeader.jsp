...
--%>
		...
		<link href="${basepath}/common/CSS/MobileCSS/MStyles.css" rel="stylesheet" type="text/css"/>

		<link href="${basepath}/common/CSS/MobileCSS/MBaseLayers.css" rel="stylesheet" type="text/css"/>
