<section class="container-fluid topMenu">
	<div class="row">
		...
		<ul class="horizontal col-lg-5 col-md-6 col-sm-7 text-right " style="margin-bottom: 0px">
		...
		<div class="col-lg-1 col-md-2 text-left visible-lg visible-md " >
			<div class="btn-group col-lg-12 col-md-7 col-md-offset-1 hidden-sm hidden-xs ">
