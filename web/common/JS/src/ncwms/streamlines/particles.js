...
var numparticles = ( localStorage == null ) ? defNumParticles : ( (localStorage.particles_num !== "NaN" && typeof localStorage.particles_num !== 'undefined') ? parseInt(localStorage.particles_num) : defNumParticles);//Initial number of particles
var defParticleSpeed = ( localStorage == null ) ? 0.0003 : (typeof layerDetails.defParticleSpeed !== 'undefined') ? parseFloat(layerDetails.defParticleSpeed) : 0.0003;
var particleSpeed = ( localStorage == null ) ? defParticleSpeed :(localStorage.particles_speed !== "NaN" && typeof localStorage.particles_speed !== 'undefined') ? parseFloat(localStorage.particles_speed) : defParticleSpeed;
...
var timeParticle = ( localStorage == null ) ? defTimeParticle : (localStorage.particles_lifetime !== "NaN" && typeof localStorage.particles_lifetime !== 'undefined') ? parseInt(localStorage.particles_lifetime) : defTimeParticle; // Number of frames a particle is alive in the animation
