    ...
    if("getParams" in currSource && _mainlayer_zaxisCoord){
        ...
        if(typeof time_ !== "undefined" && currSource.getParams().ncwmstwo){
            ...
            if(ajaxCan){
                ...
                $("#prevVP").click(function(){  });
                
                $("#nextVP").click(function(){  });
...
owgis.features.punctual.getWindRose= function getWindRose(event,layerNumber) {
	...
	if(time !== undefined){
		...
		url = layerDetails.windrose;
                ...
                today = yyyy + "-" + mm + '-' + dd ; //date like 2018-07-23 
                    
                if( layerDetails.name.indexOf("Dom1") ){
                    url+="Dom1_"+today+".nc/"; //name like Dom1_2018-07-23.nc
                } else {
                    url+="Dom2_"+today+".nc/"; //name like Dom1_2018-07-23.nc
                }
