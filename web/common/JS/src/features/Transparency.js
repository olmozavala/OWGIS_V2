...
var maxOpacity = 1;
var minOpacity = 0.1;
var opacity = (localStorage.transparency_layer !== "NaN" && typeof localStorage.transparency_layer !== 'undefined') ? localStorage.transparency_layer : .95 ; //.95;//Default opacity
